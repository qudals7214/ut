...
public class QuasarzoneCrawling{
    ...
    public List<DataVO> search(String search) {
        ...
        try {
            for (int i = FIRST_PAGE_INDEX; i <= LAST_PAGE_INDEX; i++) {
                final String startUrl = "https://quasarzone.com/bbs/qb_saleinfo?_method=post&kind=subject%7C%7Ccontent&keyword="+search+"&sort=num%2C%20reply&direction=DESC&page=" + i;
