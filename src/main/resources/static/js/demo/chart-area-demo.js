...
// dateList2=$("[name=dateList2]").val();
// itemList2=$("[name=itemList2]").val();
// priceList2=$("[name=priceList2]").val();
console.log(dateList2);
console.log(itemList2);
console.log(priceList2[0]);
console.log(priceList2[1]);
console.log(priceList2[2]);
console.log(priceList2[3]);
    ...
    options: {
        ...
        tooltips: {
            ...
            callbacks: {
                label: function(tooltipItem, chart) {
                    // var datasetLabel = chart.datasets[tooltipItem.datasetIndex].label || '';
                    // var datasetLabel = itemList2[tooltipItem.datasetIndex];
                    // var datasetLabel = itemList2[chart.datasets[tooltipItem.datasetIndex]] || '';
                    let title = itemList2[tooltipItem.index];
                    var datasetLabel = chart.datasets[tooltipItem.datasetIndex].label || '';
